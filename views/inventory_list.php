...
<body>
  ...
  <div class="panel panel-success col-md-10 col-md-offset-1">
    ...
    <nav class="navbar navbar-inverse">
        <ul class="nav navbar-nav">
          <li><a href="<?php echo base_url().'Liquor'?>">Liquor</a></li>
        </ul>
        ...
        <ul class="nav navbar-nav">
          <li class="active"><a href="<?php echo base_url().'Inventory_list'?>">Inventory</a></li>
        </ul>
    </nav>
    ...
    <br>
		...
		<div class="panel panel-primary">
		<div class="panel-heading"><center>Day Stock Out</center></div>
		<div class="panel-body" style="height:350; overflow-y: scroll;">
		<div class="panel-body">
   ...
   <!--   <div class="panel panel-primary">
  		<div class="panel-heading"><center>Month Stock Out</center></div>
  		<div class="panel-body" style="height:350; overflow-y: scroll;">
  		<div class="panel-body">
      <div class="table">
			  <table class="table">
...
<!--modals-->
    ...
    <div class="modal-dialog">
      ...
      <!--asdfsadf-->
	  <p></p>
      <form method="post" action="Inventory_list_stock/New_Stock_form_validation">
        ...
        <div class="input-group" style="width: 100%;">
				  ...
				  <input type="text" class="form-control" style="width: 98%;" name="quantity" placeholder="Quantity of Quantity bottles">
				</div>
				<br>
  ...
  <div class="modal fade" id="stockintake" role="dialog">
    <div class="modal-dialog">
      ...
      <!--asdfsadf-->
	  <p></p>
      <form method="post" action="Inventory_list_stock/Stock_in_form_validation">
				<div class="input-group" style="width: 100%;">
        ...
        <div class="input-group" style="width: 100%;">
				  ...
				  <span class="input-group-addon" style="width: 20%;">Quantity - Quantity</span>
				  <input type="text" class="form-control" style="width: 98%;" name="quantity" placeholder="Quantity of Quantity Quantity bottles">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
		...
		<p></p>
      <!--asdfsadf-->
      <form method="post" action="Inventory_list_stock/Stock_out_form_validation">
				<div class="input-group" style="width: 100%;">
