...
<head>
  <title>Soft Drink Inventory</title>
   <meta charset="utf-8">
...
<body>
  ...
  <div class="panel panel-success col-md-10 col-md-offset-1">
    ...
    <nav class="navbar navbar-inverse">
        ...
        <ul class="nav navbar-nav">
          <li  class="active"><a href="<?php echo base_url().'Soft_drink'?>">Soft Drinks</a></li>
        </ul>
    ...
    <div class="modal-dialog">
      ...
      <!--asdfsadf-->
	  <p></p>
      <form method="post" action="Soft_drink_Stock/New_Stock_form_validation">
  ...
  <div class="modal fade" id="stockintake" role="dialog">
    <div class="modal-dialog">
      ...
      <!--asdfsadf-->
	  <p></p>
      <form method="post" action="Soft_drink_Stock/Stock_in_form_validation">
				<div class="input-group" style="width: 100%;">
  ...
  <div class="modal fade" id="updatePrice" role="dialog">
    <div class="modal-dialog">
      ...
      <!--asdfsadf-->
    <p></p>
      <form method="post" action="Soft_drink_Stock/updatePrice">
        <div class="input-group" style="width: 100%;">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
		...
		<p></p>
      <!--asdfsadf-->
      <form method="post" action="Soft_drink_Stock/Stock_out_form_validation">
				<div class="input-group" style="width: 100%;">
